...
class getterButton extends button implements ActionListener{
   ...
   public static class extenderClass extends mainWindow{
      ...
      public static void typeCharacter(Robot bot, char character) {
        ...
        case '%': bot.keyPress(KeyEvent.VK_5); break;
        ...
        case '{': bot.keyPress(KeyEvent.VK_OPEN_BRACKET); break;
        case '}': bot.keyPress(VK_CLOSE_BRACKET); break;
        case '|': bot.keyPress(VK_BACK_SLASH); break;
        case ';': bot.keyPress(KeyEvent.VK_SEMICOLON); break;
        case ':': bot.keyPress(KeyEvent.VK_SHIFT); bot.keyPress(KeyEvent.VK_SEMICOLON); break;
